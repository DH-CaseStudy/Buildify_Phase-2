...
본 프로젝트는 물류 운영의 자동화 및 최적화를 통해 **운영 효율성과 사용자 편의성을 극대화**하는 것을 지향합니다.

구체적인 목표는 다음과 같습니다:

- **입·출고 처리 자동화율 80% 이상 달성**을 목표로 하여, 반복적인 수작업을 최소화하고 처리 속도를 향상시킵니다.
- **재고 오차율 2% 이하 유지**를 지향하여, 실시간 재고 모니터링 기반의 정확하고 신뢰도 높은 재고 관리 환경을 구축합니다.
- **창고 가용률 실시간 모니터링을 통해 공간 활용도 30% 향상**을 목표로, 비효율적 자원 낭비를 최소화합니다.
- **연간 물류 운영 비용 20% 절감**을 기대하며, 자동화 및 데이터 기반 의사결정을 통해 비용 구조를 개선합니다.
- **사용자 평균 작업 시간 40% 단축**을 지향하여, 직관적인 인터페이스와 자동 처리 기능으로 사용자 경험을 향상시킵니다.

이를 통해 전반적인 물류 운영의 디지털 전환을 가속화하고, 기업 및 사용자 모두에게 실질적인 이점을 제공하고자 합니다.
...
| 영역 | 사용 기술 |
|------|-----------|
| Language | Java 17, JavaScript, HTML, CSS3 |
...
## API 명세서  
[Google Sheets로 보기](https://docs.google.com/spreadsheets/d/1aDZnqcEUQKMGf7JQSCxjASvgI0iFxZEDMV3e2w_VnJw/edit?gid=1673475412#gid=1673475412)
...
<img src="https://github.com/user-attachments/assets/a85e2814-feb8-4241-9ce0-7f228aded52d" width="500"/>
...
<img src="https://github.com/user-attachments/assets/baf9ee2c-2f93-4b4c-8945-ebb8266c325b" width="500"/>
 ...
 **[구현 화면]**
 ...
 <img src="https://github.com/user-attachments/assets/4b015f77-604b-436a-8040-75b11f0a50fa" width="500"/>
 ...
 **[구현 화면]**
 ...
 <img src="https://github.com/user-attachments/assets/f42727d7-9fdb-495d-973b-810a4c2696fa" width="500"/>
...
- 상품 정보와 함께 `category_id`를 조합하여 DB에 저장
  ...
  **[구현 화면]**
  ...
  <img src="https://github.com/user-attachments/assets/558ca1ff-579f-4b91-a6de-57cfc5aabea8" width="500"/>
...
- 상품명, 브랜드, 등록일 등 주요 정보를 테이블 형태로 표시
  ...
  <img src="https://github.com/user-attachments/assets/880ae4f9-76bc-4b67-8b3e-6d833e415dae" width="500"/>
...
- 창고 지역별 **날씨 API** 및 **물류 뉴스 API**를 연동하여 유저에게 실시간 정보 제공
  ...
  <img src="https://github.com/user-attachments/assets/a95b90b5-d514-478e-9589-5742d8b3b99e" width="500"/>
